package indi.midreamsheep.schatapp.backend.entity.protocol.chat.resonse.data.result.login;

import indi.midreamsheep.schatapp.backend.entity.protocol.chat.resonse.data.result.ResultData;
